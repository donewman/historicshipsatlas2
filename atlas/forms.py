...
class SearchForm(forms.Form):
    ...
    city = forms.CharField(label='Location - City (Static Ships Only):', max_length=200, required=False)
    country = forms.ModelMultipleChoiceField(label='Location - Country (Static Ships Only):', queryset=Country.objects.all().order_by('name'), required=False)
